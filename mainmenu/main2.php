...
<html>
	<head>
		<title>Приветствие для технического работника</title>
		<style type="text/css">
			#layer1 
			{
				width: 560px;
	...
	<body>
		...
		<b>
			...
			Вам, как техническому работнику, доступно внесение информации о подключении и отключении услуг,
			выполнение запросов к базе данных, а также получение отчетов о выполнении хранимой процедуры.<br><br>
