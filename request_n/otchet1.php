...
<html>
<head>
	<title>Результат запроса 1</title>
	<style type="text/css">
		.button
		{
			cursor:	pointer;
	...
	<body style="background: #FFFFF0;">
		<div>
			<center>
				<p class="headline">Отчет о подключении услуг в <?php echo $d2;?> месяце
					<?php echo $d1;?> года:</p>
				<table border=3>
					<tbody>
						<tr height=40px>
							...
							<td align=center width=100px> <b>Количество подключений</b> </td>
						</tr>
