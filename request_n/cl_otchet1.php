...
<html>
	<head>
		<title>Результат клиентского запроса 1</title>
		<style type="text/css">
		.button
		{
			cursor:	pointer;
	...
	<base target="_top">
		<div>
			<center>
				<p class="headline">Количество подключенных услуг у Ваших абонентов.</p>
				<table border=3>
					<tbody>
						<tr height=40px>
							<td align=center width=100px> <b>Мобильный номер</b> </td>
							<td align=center width=100px> <b>Количество услуг</b> </td>
						</tr>
						<?php foreach($otchets as $otchet):?>
						<tr height=40px>
							<td align=center width=100px> <?php echo $otchet['Phone_number'];?></td>
							<td align=center width=100px> <?php echo $otchet['Count(*)'];?></td>
						</tr>
						<?php endforeach ?>
					</tbody>
				</table><br><br>
